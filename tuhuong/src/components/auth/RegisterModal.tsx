  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md relative">
        <h2 className="text-xl font-bold text-center text-blue-700 mb-6">ĐĂNG KÝ</h2>

        <div className="space-y-4">
          <div className="relative">
            <Input type="text" placeholder="Tên người dùng" className="pl-8" />
            <User className="absolute left-2 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
          </div>

          <div className="relative">
            <Input type="tel" placeholder="Số điện thoại" className="pl-8" />
          ...
          <Button className="w-full bg-blue-600 hover:bg-blue-700">Tạo tài khoản</Button>
